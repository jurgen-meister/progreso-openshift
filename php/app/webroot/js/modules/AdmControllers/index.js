/* (c)Bittion Admin Module | Created: 15/08/2014 | Developer:reyro | JS: AdmControllers/index */
jQuery(document).ready(function() {
//START SCRIPT
//************************************** EXEC MAIN - START **************************************
//    Created: 15/08/2014 | Developer: reyro | Description: initiate DataTable
    var table1 = jQuery('#AdmControllerIndexDT').DataTable({
        ...
        , 'fnCreatedRow': function(nRow, aData, iDataIndex) {
            ...
            jQuery('td:eq(2)', nRow).html('<a href="#" id="description-' + aData[3] + '"  class="AdmControllerDescription" data-pk="' + aData[3] + '">' + aData[2] + '</a>');
...
//    Created: 15/08/2014 | Developer: reyro | Description: generates Html Row Buttons Edit and Delete
...
//    Created: 15/08/2014 | Developer: reyro | Description: bind events to DataTable Html Controls
...
//    Created: 15/08/2014 | Developer: reyro | Description: restores logic deleted users | Request:Ajax
        ...
        jQuery.ajax({
            ...
            success: function(response) {
                if (response['status'] === 'SUCCESS') {
                    ...
                    table1
                            .row(objectButton.parents('tr'))  //also works .closest('tr')
                            .remove()
                            .draw();
                } else {
                    bittionShowGrowlMessage(response['status'],response['title'],response['content']);
    ...
    function fnUpdateXEditable() {
        jQuery('.AdmControllerDescription').editable({
            type: 'text',
